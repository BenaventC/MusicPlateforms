...
Le code lit un fichier csv nommé `"MusicPlateform2.csv"` et l'assigne à un dataframe `df`. Ce fichier vient de l'enquête sur les plateformes musicales dont le questionnaire est [**ici**]() (N'hésitez pas à y répondre!)
